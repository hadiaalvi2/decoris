      ...
      <div className="min-h-screen relative bg-cover bg-center bg-no-repeat" style={{ backgroundImage: "url('/assets/bg.jpg')" }}>
        ...
        <div className="relative z-10 w-full max-w-screen-2xl mx-auto">
          ...
          <nav className="flex items-center justify-between px-3 py-3 sm:px-4 sm:py-4 md:px-8 lg:px-16 lg:py-6">
            ...
            {/* Right side icons - Same for both */}
          ...
          <div className="lg:hidden flex items-center justify-between px-4 py-6">
              {/* Product Title */}
              <h3 className= "text-black text-[10px] font-normal tracking-wider whitespace-nowrap ml-20">
            ...
            <div className="w-full lg:w-2/5 px-4 py-6 lg:px-8 lg:py-8 lg:pr-20 flex flex-col justify-center">
              <div className="max-w-lg mx-auto w-full text-center lg:text-left">
                ...
                <div className="lg:hidden mt-8">
                  <p className="text-xs text-gray-600 tracking-wide leading-relaxed text-center">
                    This item is carefully crafted by skilled artisans, who devote continuous care to its creation.
                    As a result of its handmade and hand-finished nature, variations in glass, marble, metal, woodwork, and other materials are to
                    be expected and celebrated. Each item is unique and possesses its individuality, ensuring that no two items are exactly alike.
                  </p>
                </div>
              </div>
